...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppPopupPopupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    PopupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 12,
      vars: 2,
      consts: [[1, "font", 2, "text-align", "center", "color", "black", "font", "normal 20px", "background-color", "white"], [2, "font-size", "80%", "color", "black"], ["id", "school", "name", "schoo", "type", "text", 2, "width", "60%", "color", "red", "border", "1px solid black", 3, "ngModel", "ngModelChange"], [3, "click"]],
